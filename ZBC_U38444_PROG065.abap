...
* Freiplatzberechnung in FUBA1
    CALL FUNCTION 'Z_BC_U38444_FUBA1'
      EXPORTING
        i_max      = gs_struc2-seatsmax
        i_occ      = gs_struc2-seatsocc
      IMPORTING
        e_frei     = gs_struc2-freiplatz
      EXCEPTIONS
        ueberbucht = 1
        OTHERS     = 2.
    IF sy-subrc <> 1.
      MESSAGE TEXT-006 TYPE 'A'.
    ELSEIF sy-subrc <> 2.
      MESSAGE TEXT-007 TYPE 'x'.
    ENDIF.
